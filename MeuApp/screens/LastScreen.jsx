  ...
  return (
    <View style={styles.container}>
      <Image
        ...
        resizeMode="contain"
      />
      <Text style={styles.title}>Acabou!</Text>
      <Text style={styles.text}>Agradecemos a preferencia e esperamos que
        voce utilize o máximo possivel desse app
        e que ele resolva todos os seus problemas!
        Bons cortes!</Text>
